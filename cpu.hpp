...
public:
  ...
  word_t decompress(hword_t halfword);
...
word_t Cpu::decompress(hword_t halfword) {
  auto opcode = halfword & 0x3; // [1:0]
  auto funct3 = (halfword >> 13) & 0x7; // [15:13]
  // @TODO not an INT
  int funct2;
  int rd, rs1, rs2, offset;
  int imm, imm1, imm2, imm11_5, imm4_0, funct1;
  int r, shamt, nzuimm, nzimm, funct2_2; // what the fuck is this?
